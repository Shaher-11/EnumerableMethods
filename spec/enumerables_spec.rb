...
describe Enumerable do
    ...
    describe "my_each_with_index" do 
      ...
      it "prints the elements in the array with their indeces" do
        expect { [1, 2, 5].my_each_with_index { |el, idx| puts el.to_s + ' ' + idx.to_s } }.to output("1 0\n2 1\n5 2\n").to_stdout
      end

      it "prints the elements in the range with their indeces" do
        expect { (1..5).my_each_with_index { |el, idx| puts el.to_s + ' ' + idx.to_s } }.to output("1 0\n2 1\n3 2\n4 3\n5 4\n").to_stdout
      end
      ...
      it 'should print the items in the array of strings with their indeces' do
        expect { %w[shaher and felix tests].my_each_with_index { |x, index| puts x.to_s + ' ' + index.to_s } }.to output("shaher 0\nand 1\nfelix 2\ntests 3\n").to_stdout
      end
